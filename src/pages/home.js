                            ...
                            <div className="user-info">
                                ...
                                <div className="user-details">
                                    ...
                                    <div className="detail-2">
                                        {realName && <p className="real-name">{realName}</p>}
                                        {status && <p className={`status ${getStatusClass(status)}`}>{status}</p>}
                                        {lastOnline && <p className="last-online">Naposledy online {lastOnline}</p>}
                                    </div>
                                    ...
                                    <li key={game.appid} className="game-item">
                                        <div className="game-row">
                                            ...
                                            <div className="game-info">
                                                ...
                                                <p className="game-hour">Nahráno: <a className="hour">{Math.round((game.playtime_forever || 0) / 60)} hodin</a></p>
                                                <p className="game-hour">Za poslední 2 týdny: <a className="hour">{Math.round((game.playtime_2weeks || 0) / 60)} hodin</a></p>
                                            </div>
                                        </div>
                                    </li>
                                ))}
